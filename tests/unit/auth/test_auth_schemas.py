...
Covers:
- CreateTenantSchema.email validated with EmailStr
...
class TestCreateTenantSchemaEmailValidation:
    """CreateTenantSchema.email must use EmailStr for format validation."""

    BASE_KWARGS = {
        "tenant_name": "Mi Campo",
        "slug": "mi-campo",
        "name": "Test User",
        "dni": "12345678",
    }
