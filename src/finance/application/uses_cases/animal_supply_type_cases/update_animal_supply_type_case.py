...
from src.finance.domain.value_objetcts.animal_supply_type_value_objects import AnimalSupplyTypeUpdateValueObject
...
class UpdateAnimalSupplyTypeCase:
    ...
    async def execute(self, id: UUID, data: AnimalSupplyTypeUpdateValueObject) -> None:
        async with self.uow as uow:
            ...
            await self.service.update_supply_type(id, data, repository)
            await uow.commit()
