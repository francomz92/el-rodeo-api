...
class Subscription(Model):
    ...
    mp_preference_id: Mapped[str | None] = mapped_column(VARCHAR(255), nullable=True, default=None)
    mp_subscription_id: Mapped[str | None] = mapped_column(VARCHAR(255), nullable=True, default=None)
