...
class ScheduleEventsQueryParams(BaseModel):
    ...
    type: AnimalEventType | None = Field(None, description="Type of event")
...
class ScheduleEventCreationSchema(BaseModel):
    ...
    type: AnimalEventType = Field(..., description="Type of event")
