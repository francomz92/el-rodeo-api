...
| Plan | Tenants | Animals | Sales/month | Users | Features |
|------|---------|---------|-------------|-------|----------|
| FREE | 1 | 50 | 100 | 5 | None |
| PRO | 3 | 500 | 1000 | 25 | CSV export |
| ENTERPRISE | -1 | -1 | -1 | -1 | All features |

- `-1` means unlimited. ENTERPRISE has no numerical limits.
