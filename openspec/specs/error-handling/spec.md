...
The system MUST return a generic `"Internal server error"` message for all unhandled exceptions. The original exception detail MUST be written to the application log and MUST NOT appear in the response body.
